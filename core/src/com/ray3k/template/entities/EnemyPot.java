...
public class EnemyPot extends EnemyEntity {
    public static final float TARGET_SPEED = 25f;
    ...
    public void act(float delta) {
        deltaX = Utils.approach(deltaY, 0, ACCELERATION * delta);
        deltaY = Utils.approach(deltaY, TARGET_SPEED, ACCELERATION * delta);
        if (getCollisionBoxBottom() > 576) destroy = true;
