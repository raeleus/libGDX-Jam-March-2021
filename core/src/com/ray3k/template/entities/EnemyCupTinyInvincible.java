...
public class EnemyCupTinyInvincible extends EnemyEntity {
    public static final float TARGET_SPEED = 800f;
    ...
    public void create() {
        ...
        health = 100f;
        invincible = true;
        skeleton.setSkin(teacupTinySkin);
        animationState.setAnimation(0, animationAnimation, true);
        animationState.setAnimation(1, rainbowAnimation, true);
