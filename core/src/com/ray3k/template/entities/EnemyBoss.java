...
public class EnemyBoss extends EnemyEntity {
    ...
    public static final float HEALTH_START = 30000f;
        ...
        if (timer < 0) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    var mortar = new EnemyMortarRound();
    ...
    public void hurt(float damage, float recoilSpeed) {
        ...
        if (!destroy && health < 0) {
            ...
            for (var entity : entityController.entities) {
                if (entity instanceof EnemyMortarRound || entity instanceof Knife) {
                    entity.destroy = true;
                }
            }
